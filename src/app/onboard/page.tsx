  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="bg-slate-800 rounded-lg p-8 mb-8">
        {currentStep === 'account' && <AccountSetup />}
        {currentStep === 'employee' && <CreateEmployee />}
        {currentStep === 'knowledge' && <KnowledgeBase />}
        {currentStep === 'integrations' && <Integrations />}
        {currentStep === 'voice' && <VoiceTraining />}
        {currentStep === 'deploy' && <DeployToSlack />}
      ...
      <div className="flex justify-between">
        ...
        >
          {currentStep === 'deploy' ? 'Launch' : 'Next'}
        </button>
      </div>
    </div>
  )
      ...
      <div className="space-y-3">
        {[
          ...
          <button
            ...
            className="w-full flex items-center p-4 rounded-lg border border-slate-600 hover:bg-slate-700 text-slate-300 hover:text-white transition"
          >
  ...
  return (
    <div>
      ...
      <div className="bg-slate-700 rounded-lg p-6 mb-6">
        ...
        <select className="w-full px-4 py-2 rounded-lg bg-slate-600 text-white">
